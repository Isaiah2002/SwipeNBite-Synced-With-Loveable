...
export const restaurants: Restaurant[] = [
  ...
  },
  {
    ...
    distance: 0.5,
    image: dinerImage,
    description: 'DC bagel shop serving NY/Montreal-style bagels with honey. Chef-driven deli classics with a playful twist.',
